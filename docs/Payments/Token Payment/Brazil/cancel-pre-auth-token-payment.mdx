...
# Cancel Pre-Auth Token Payment

```jsx
  https://api-sandbox.epag.io/token/MY_PAYMENT_TOKEN/cancel
```

Cancels a pre-authorized payment that were already sent using the `Process Token Payment` method.
  ...
  <TabItem value="success" label="200 - Success">
    #### Example Request
      ```jsx title="200 - Success"
          curl --location --request DELETE 'https://api-sandbox.epag.io/token/MY_PAYMENT_TOKEN/cancel' \
  ...
  <TabItem value="unauthorized" label="401 - Unauthorized">
    #### Example Request
      ```jsx title="401 - Unauthorized"
          curl --location --request POST 'https://api-sandbox.epag.io/token/MY_PAYMENT_TOKEN/cancel' \
      ...
      ```jsx title="Body"
          {
            ...
            "path": "/token/633de157-9a42-4d30-bbad-bd9fb883e058/cancel"
          }
      ```
  </TabItem>
      ...
      ```jsx title="Body"
          {
            ...
            "path": "/token/2f1c0103-b6fe-4e99-864c-d20c68b97a85/cancel",
            "errors": [
              {
                "code": "00.03.0001",
